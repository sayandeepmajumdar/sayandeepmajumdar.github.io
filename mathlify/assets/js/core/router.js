...
const LEGACY_MAP = {
  ...
  '#/calorie-calculator':    'tools/calorie-calculator.html',
  '#/triangle-calculator':   'tools/triangle-calculator.html',
  '#/volume-calculator':     'tools/volume-calculator.html',
  '#/slope-calculator':      'tools/slope-calculator.html',
  '#/area-calculator':       'tools/area-calculator.html',
  '#/distance-calculator':   'tools/distance-calculator.html',
  '#/circle-calculator':     'tools/circle-calculator.html',
  '#/surface-area-calculator': 'tools/surface-area-calculator.html',
  '#/pythagorean-calculator': 'tools/pythagorean-calculator.html',
  '#/right-triangle-calculator': 'tools/right-triangle-calculator.html',
