...
import type { EraQuiz, EraInfo } from '../../types/itihaas';
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-white/10 relative z-10">
        <div>
          ...
          <p className="text-stone-400 text-xs sm:text-sm mt-1 max-w-xl">{quiz.subtitle}</p>
        </div>
      ...
      {isCompleted && (
        <div className="mt-10 p-6 sm:p-8 rounded-2xl border border-amber-500/40 bg-gradient-to-r from-amber-500/15 via-[#131929] to-[#0f1422] text-center space-y-4 animate-fade-in relative z-10">
