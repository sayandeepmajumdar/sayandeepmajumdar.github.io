...
import type { IngredientGroup } from '../../types/rasoi';
...
export const ServingsScaler: React.FC<ServingsScalerProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 rounded-2xl bg-amber-50/80 border border-amber-200/80">
      ...
      <div className="space-y-6">
        {ingredients.map((group, groupIdx) => (
          <div key={groupIdx} className="space-y-3">
            <h3 className="font-serif font-bold text-base text-rose-950 pb-1.5 border-b border-stone-200/90 flex items-center gap-2">
