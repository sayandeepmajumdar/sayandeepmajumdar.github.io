...
export const DestinationPanel: React.FC<DestinationPanelProps> = ({
  ...
  return (
    <div
      className="w-full max-w-xl rounded-3xl glass-panel shadow-2xl border border-white/15 overflow-hidden backdrop-blur-2xl transition-all duration-300 transform scale-100 opacity-100 animate-fade-in"
    >
